# -*- encoding: utf-8 -*-
# stub: web-console 4.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<railties>.freeze, [">= 6.0.0.a"])
      s.add_runtime_dependency(%q<activemodel>.freeze, [">= 6.0.0.a"])
      s.add_runtime_dependency(%q<actionview>.freeze, [">= 6.0.0.a"])
      s.add_runtime_dependency(%q<bindex>.freeze, [">= 0.4.0"])
    else
      s.add_dependency(%q<railties>.freeze, [">= 6.0.0.a"])
      s.add_dependency(%q<activemodel>.freeze, [">= 6.0.0.a"])
      s.add_dependency(%q<actionview>.freeze, [">= 6.0.0.a"])
