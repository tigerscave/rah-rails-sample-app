# -*- encoding: utf-8 -*-
# stub: activesupport 6.0.0.rc1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0.rc1/activesupport/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0.rc1/activesupport" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<zeitwerk>.freeze, ["~> 2.1", ">= 2.1.4"])
    else
      ...
      s.add_dependency(%q<zeitwerk>.freeze, ["~> 2.1", ">= 2.1.4"])
    end
  else
    s.add_dependency(%q<i18n>.freeze, [">= 0.7", "< 2"])
    s.add_dependency(%q<tzinfo>.freeze, ["~> 1.1"])
